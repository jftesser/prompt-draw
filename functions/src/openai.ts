...
import { CompletionCreateParamsNonStreaming, CreateChatCompletionRequestMessage } from 'openai/resources/chat/completions';
...
export const  getDalle = async (msg: string, n = 1) => {
  ...
  export const getChat = async(msgs: Array<CreateChatCompletionRequestMessage>, temp: number, model = "gpt-4", functions : OpenAI.Chat.Completions.CompletionCreateParams.Function[][] | null = null) => {
